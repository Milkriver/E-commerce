...
export const Cart = ({ cart, removeItemHandler, addItemHandler }) => {
    const summaryPrice = cart.reduce((accum, elem) => accum + elem.price * elem.quantity, 0) / 100
    const summaryTax = (summaryPrice / 10);
    const total = summaryPrice + summaryTax;
